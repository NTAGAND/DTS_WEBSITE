                        ...
                        <div class="demo-box m-t-20">
                           ...
                           <div class="table-responsive">
                              <table class="table m-0 table-bordered" id="example">
                                 ...
                                 <tbody>
                                    <?php 
                                       $query=mysqli_query($con,"Select id,logo,CategoryName,Description,PostingDate,UpdationDate from  tblcategory where Is_Active=1");
                                       $cnt=1;
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo htmlentities($row['logo']);?></td>
